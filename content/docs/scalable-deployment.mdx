...
This document summarizes a technical discussion about how to deploy, scale, and update applications using **managed instance groups (MIG)** — collections of identical servers that are managed as a single unit.
